...
void add_data_from_run(string run_num){
  
cout<<"Analysing data from run "<<run_num<<endl;

//std::string file_1 = "/sps/nemo/scratch/golivier/aussois_tuto_data/bi207_run/snemo_run-840_udd.root";//Chosen run file 
std::string file_1 = "/sps/nemo/snemo/snemo_data/reco_data/UDD/delta-tdc-10us-v3/snemo_run-"+run_num+"_udd.root";


cout<<"Running calo analysis on run "<<run_num<<endl;
...
TFile *file= new TFile(file_1.c_str(), "READ");
 ...
 // TH2D** t5_vs_drift_edge = make_array_of_hist("t5_vs_drift_edge",1000,-1000,5000,1000,0,80000);
 // TH2D** t6_vs_drift_edge = make_array_of_hist("t6_vs_drift_edge",1000,-1000,5000,1000,0,80000);
 // TH2D** t5_vs_drift_middle = make_array_of_hist("t5_vs_drift_middle",1000,-1000,5000,1000,0,80000);
 // TH2D** t6_vs_drift_middle = make_array_of_hist("t6_vs_drift_middle",1000,-1000,5000,1000,0,80000);
   ...
   //TH2D** drift_time_vs_prop_time_per_cell3 = make_array_of_hist("drift_time_vs_prop_time_per_cell",1000,-1000,5000,1000,30000,80000);
   //TH2D** drift_time_vs_prop_time_per_cell4 = make_array_of_hist("drift_time_vs_prop_time_per_cell",1000,-1000,5000,1000,30000,80000);
   //TH2D** drift_time_vs_prop_time_per_cell5 = make_array_of_hist("drift_time_vs_prop_time_per_cell",1000,-1000,5000,1000,30000,80000);
   //TH2D** drift_time_vs_prop_time_per_cell6 = make_array_of_hist("drift_time_vs_prop_time_per_cell",1000,-1000,5000,1000,30000,80000);
   //TH2D** drift_time_vs_prop_time_per_cell7 = make_array_of_hist("drift_time_vs_prop_time_per_cell",1000,-1000,5000,1000,30000,80000);
   //TH2D** drift_time_vs_prop_time_per_cell8 = make_array_of_hist("drift_time_vs_prop_time_per_cell",1000,-1000,5000,1000,30000,80000);
   //TH2D** drift_time_vs_prop_time_per_cell9 = make_array_of_hist("drift_time_vs_prop_time_per_cell",1000,-1000,5000,1000,30000,80000);
...
int no_events_to_run = 1000;
cout<<"No. events: "<<no_events_to_run<<endl;
...
//selecting different drift time data plots by height so can see the dependance on prop time dependance for different z values
          drift_time_vs_prop_time_per_cell[cell_num]->Fill(R0-RC,prop_time,1);
/*
              if (z>-0.8 && z<-0.6){
              drift_time_vs_prop_time_per_cell2[cell_num]->Fill(R0-RC,prop_time,1);}
              if (z>-0.6 && z<-0.4){
              drift_time_vs_prop_time_per_cell3[cell_num]->Fill(R0-RC,prop_time,1);}
              if (z>-0.4 && z<-0.2){
              drift_time_vs_prop_time_per_cell4[cell_num]->Fill(R0-RC,prop_time,1);}
              if (z>-0.2 && z<0){
              drift_time_vs_prop_time_per_cell5[cell_num]->Fill(R0-RC,prop_time,1);}
              if (z>0 && z<0.2){
              drift_time_vs_prop_time_per_cell6[cell_num]->Fill(R0-RC,prop_time,1);}
              if (z>0.2 && z<0.4){
              drift_time_vs_prop_time_per_cell7[cell_num]->Fill(R0-RC,prop_time,1);}
              if (z>0.4 && z<0.6){
              drift_time_vs_prop_time_per_cell8[cell_num]->Fill(R0-RC,prop_time,1);}
              if (z>0.6 && z<0.8){
              drift_time_vs_prop_time_per_cell9[cell_num]->Fill(R0-RC,prop_time,1);}
   

          if (z>-0.8 && z<-0.7){
              t5_vs_drift_edge[cell_num]->Fill(R0-RC,R5-R0,1);
              }
          if (z>-0.8 && z<-0.7){
              t6_vs_drift_edge[cell_num]->Fill(R0-RC,R6-R0,1);
              }
          if (z>-0.05 && z<0.05){
              t5_vs_drift_middle[cell_num]->Fill(R0-RC,R5-R0,1);
              }
          if (z>-0.05 && z<0.05){
              t6_vs_drift_middle[cell_num]->Fill(R0-RC,R6-R0,1);
              }
...
save_all_cell_hists(drift_time_vs_prop_time_per_cell,"individual_cell_data/drift_time_vs_prop_time_per_cell_angle_data",run_num);
//saving all height variations of drifttime vs proptime
//save_all_cell_hists(drift_time_vs_prop_time_per_cell2,"individual_cell_data/drift_time_vs_prop_time_per_cell_height_02",run_num);
//save_all_cell_hists(drift_time_vs_prop_time_per_cell3,"individual_cell_data/drift_time_vs_prop_time_per_cell_height_03",run_num);
//save_all_cell_hists(drift_time_vs_prop_time_per_cell4,"individual_cell_data/drift_time_vs_prop_time_per_cell_height_04",run_num);
//save_all_cell_hists(drift_time_vs_prop_time_per_cell5,"individual_cell_data/drift_time_vs_prop_time_per_cell_height_05",run_num);
//save_all_cell_hists(drift_time_vs_prop_time_per_cell6,"individual_cell_data/drift_time_vs_prop_time_per_cell_height_06",run_num);
//save_all_cell_hists(drift_time_vs_prop_time_per_cell7,"individual_cell_data/drift_time_vs_prop_time_per_cell_height_07",run_num);
//save_all_cell_hists(drift_time_vs_prop_time_per_cell8,"individual_cell_data/drift_time_vs_prop_time_per_cell_height_08",run_num);
//save_all_cell_hists(drift_time_vs_prop_time_per_cell9,"individual_cell_data/drift_time_vs_prop_time_per_cell_height_09",run_num);

//save_all_cell_hists(t5_vs_drift_edge,"individual_cell_data/t5_vs_drift_edge",run_num);
//save_all_cell_hists(t6_vs_drift_edge,"individual_cell_data/t6_vs_drift_edge",run_num);
//save_all_cell_hists(t5_vs_drift_middle,"individual_cell_data/t5_vs_drift_middle",run_num);
//save_all_cell_hists(t6_vs_drift_middle,"individual_cell_data/t6_vs_drift_middle",run_num);
...
add_data_from_run("1066");
add_data_from_run("1001");
